...
requirements-completed: [AUTH-01, AUTH-02, RUN-01, OPS-01]
---

# Acceso, instalación y recepción — ejecución

## Implementación

Cuentas personales y roles; CSRF, sesión, inicio vacío/demo; datos por defecto fuera de OneDrive; clientes, vehículos, citas y orden persistentes. La semilla no deja credenciales activas.

Archivos principales: `workshop/access.py, workshop/views.py, milenio_web/settings.py, scripts/run_web.py, Setup-Web.ps1`.

## Comprobación

test_web.py; WebDeliveryTests: inicio, persistencia y separación; cambio/desactivación de cuenta sin perder historial.
